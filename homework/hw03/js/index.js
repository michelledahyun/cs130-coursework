...
const showImage = (ev) => {
  ...
  //  let .featured_image.backgroundImage = elem.style.backgroundImage;


    document.querySelector (".style.backgroundImage").innerHTML = sourceElement.style.backgroundImage;
